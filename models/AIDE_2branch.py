...
class AIDE2BranchModel(nn.Module):
    def __init__(self, resnet_path, convnext_path, openclip_model=None, **kwargs):
        super().__init__()
        self.hpf = HPF()
        ...
        print('build 2-branch model with convnext_xxl')
...
def AIDE_2BRANCH(resnet_path, convnext_path, openclip_model=None, **kwargs):
    return AIDE2BranchModel(
